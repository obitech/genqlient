		...
		t.Run(sourceFilename, func(t *testing.T) {
			generated, err := Generate(&Config{
				...
				Bindings: map[string]*TypeBinding{
					"ID":       {Type: "github.com/obitech/genqlient/internal/testutil.ID"},
					"DateTime": {Type: "time.Time"},
					"Date": {
						Type:        "time.Time",
						Marshaler:   "github.com/obitech/genqlient/internal/testutil.MarshalDate",
						Unmarshaler: "github.com/obitech/genqlient/internal/testutil.UnmarshalDate",
					},
					"Junk":        {Type: "interface{}"},
					"ComplexJunk": {Type: "[]map[string]*[]*map[string]interface{}"},
					"Pokemon": {
						Type:              "github.com/obitech/genqlient/internal/testutil.Pokemon",
						ExpectExactFields: "{ species level }",
					},
					"PokemonInput": {Type: "github.com/obitech/genqlient/internal/testutil.Pokemon"},
				},
...
func TestGenerateWithConfig(t *testing.T) {
	tests := []struct {
		...
		{"CustomContext", "", nil, &Config{
			ContextType: "github.com/obitech/genqlient/internal/testutil.MyContext",
		}},
		{"CustomContextWithAlias", "", nil, &Config{
			ContextType: "github.com/obitech/genqlient/internal/testutil/junk---fun.name.MyContext",
		}},
		...
		{"PackageBindings", "", nil, &Config{
			PackageBindings: []*PackageBinding{
				{Package: "github.com/obitech/genqlient/internal/testutil"},
			},
		}},
		...
		{"ClientGetter", "", nil, &Config{
			ClientGetter: "github.com/obitech/genqlient/internal/testutil.GetClientFromContext",
		}},
		{"ClientGetterCustomContext", "", nil, &Config{
			ClientGetter: "github.com/obitech/genqlient/internal/testutil.GetClientFromMyContext",
			ContextType:  "github.com/obitech/genqlient/internal/testutil.MyContext",
		}},
		{"ClientGetterNoContext", "", nil, &Config{
			ClientGetter: "github.com/obitech/genqlient/internal/testutil.GetClientFromNowhere",
			ContextType:  "-",
		}},
		...
		{"OptionalGeneric", "", []string{"ListInput.graphql", "QueryWithSlices.graphql"}, &Config{
			Optional:            "generic",
			OptionalGenericType: "github.com/obitech/genqlient/internal/testutil.Option",
		}},
