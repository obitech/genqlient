...
[![Go Reference](https://pkg.go.dev/badge/github.com/obitech/genqlient.svg)](https://pkg.go.dev/github.com/obitech/genqlient)
[![Test Status](https://github.com/obitech/genqlient/actions/workflows/go.yml/badge.svg)](https://github.com/obitech/genqlient/actions)
[![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg)](docs/CODE_OF_CONDUCT.md)
[![GoReportcard](https://goreportcard.com/badge/github.com/obitech/genqlient?status.svg)](https://goreportcard.com/report/github.com/obitech/genqlient)
...
You can download and run genqlient the usual way: `go run github.com/obitech/genqlient`.  To set your project up to use genqlient, see the [getting started guide](docs/INTRODUCTION.md), or the [example](example).  For more complete documentation, see the [docs](docs).
